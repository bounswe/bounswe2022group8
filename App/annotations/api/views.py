...
@swagger_auto_schema(
    ...
    request_body=openapi.Schema(
        ...
        properties={
            ...
            "body": openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Items(type=openapi.TYPE_OBJECT), description='body of the annotation', default='[{"type": "TextualBody","value": "Nice picture", "creator": {"id": 1, "name": "joseph.blocker"}}]'),
                ...
                "application/json": [
                    {
                        ...
                        "body": [{
                            ...
                            "modified": "2022-12-16T15:31:23.803026Z",
                            "purpose": "commenting",
                            "creator": {
                                "id": 1,
                                "name": "joseph.blocker"
