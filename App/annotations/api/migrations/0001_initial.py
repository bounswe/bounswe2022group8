# Generated by Django 4.1.2 on 2022-12-17 16:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('selectorType', models.TextField(choices=[('FragmentSelector', 'Fragmentselector'), ('SvgSelector', 'Svgselector'), ('CssSelector', 'Cssselector'), ('XPathSelector', 'Xpathselector'), ('TextQuoteSelector', 'Textquoteselector'), ('TextPositionSelector', 'Textpositionselector'), ('DataPositionSelector', 'Datapositionselector')], unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Type',
