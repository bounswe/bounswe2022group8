# Generated by Django 4.1.2 on 2022-12-16 23:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ExhibitionArtItem',
            fields=[
                ('artitem_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='api.artitem')),
            ],
            bases=('api.artitem',),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='exhibitionartitem',
            name='virtualExhibition',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.virtualexhibition'),
        ),
    ]
