...
# Generated by Django 4.1.2 on 2022-12-26 18:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('popularity', models.FloatField(default=0)),
                ('sale_status', models.CharField(choices=[('NS', 'Not For Sale'), ('FS', 'For Sale'), ('SO', 'Sold')], default='NS', max_length=2)),
                ('minimum_price', models.PositiveIntegerField(default=0)),
                ('bought_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bought_art', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('poster', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.exhibitionposter')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accepted', models.CharField(choices=[('RE', 'Rejected'), ('AC', 'Accepted'), ('NR', 'No Response')], default='NR', max_length=2)),
